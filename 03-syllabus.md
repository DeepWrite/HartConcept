...
이 강좌의 주제는 ‘나는 어떤 규범 속에 살아가는가?’이다. 허버트 하트는 『법의 개념』에서 법이란 무엇인가, 우리는 왜 법을 따르는가, 그리고 법은 도덕과 어떤 관계를 맺는가라는 질문을 던진다. 하트의 법철학은 법을 단순한 명령이나 강제력의 체계로 보지 않고, 사회 속 규칙과 그 규칙을 내부 관점에서 수용하는 태도가 결합된 실천적 질서로 이해한다. 그는 법이 작동하는 방식뿐 아니라, 시민이 법을 어떻게 받아들이고 내면화하는가를 설명하고자 한다.
...
| 3 | 법은 명령인가? | 읽기 및 토론 | 법과 명령은 어떻게 구분되는가? Austin 이론의 한계는 무엇인가? | II. Laws, Commands, and Orders |
| 4 | 다양한 법의 형태들 | 읽기 및 토론 | 모든 법은 동일한 구조를 갖는가? | III. The Variety of Laws |
| 5 | 주권자와 수범자 | 읽기 및 토론 | ‘주권’이란 무엇인가? 법은 누구의 명령인가? | IV. Sovereign and Subject |
| 6 | 1차 규칙과 2차 규칙의 결합 | 읽기 및 토론 | 법은 특정한 유형의 규칙들로 구성되어 있는 것인가? 이는 필요조건인가? | V. Law as the Union of Primary and Secondary Rules |
| 7 | 법체계의 기초 - **승인 규칙** | 읽기 및 토론 | ‘승인 규칙’은 법체계의 무엇을 보장하는가? | VI. Foundations of a Legal System |
| 8 | 형식주의와 규칙회의주의 | 읽기 및 토론 | 법해석의 불확실성과 재량의 문제는? 판사는 법을 만드는가? | VII. Formalism and Rule-Scepticism |
| 9 | 법과 정의, 도덕 | 읽기 및 토론 | 정의와 법적 절차는 어떻게 관련되는가? 도덕과 법은 같지 않지만 완전히 분리될 수 있는가? | VIII. Justice and Morality |
| 10 | 법과 도덕의 관계 | 읽기 및 토론 | Hart는 소위 ‘자연법론’에 왜 비판적인가? 법의 권위는 도덕과 어떤 관계인가? | IX. Laws and Morals |
| 11 | 국제법의 문제 | 읽기 및 토론 | 국제법은 ‘진짜 법’인가? 2차 규칙들을 발견하기 어렵다면? 법적 강제력이 없다면? | X. International Law |
| 12 | Dworkin의 비판 | 읽기 및 토론 | Dworkin는 무엇을 비판했는가? 예) 규칙과 원칙은 무엇이 다른가? | Dworkin 등의 문헌들 |
| 13 | Hart의 재반박과 연성 법실증주의 | 읽기 및 토론 | Hart는 여러 비판에 어떻게 대응했는가? |  *Postscript*  |
| 14 | 나의 법 개념 발표 1 | 발표/상호 논평 | Hart나 드워킨, 풀러 등의 법의 이해를 염두에 두고 나의 비판적 관점 제시하기 | 발표자료 |
| 15 | 나의 법 개념 발표 2 | 발표/종합 토론 | Hart나 드워킨, 풀러 등의 법의 이해를 염두에 두고 나의 비판적 관점 제시하기 | 발표자료 |
...
- 기말 과제로는 본문 기준 A4 2-3쪽의 소논문을 제출하며, ‘법이란 무엇인가’라는 큰 주제 아래 독자적인 비판적 관점을 제시해야 합니다. 구체적인 작성·평가 기준은 [소논문 과제 안내]({{ site.baseurl }}/final-paper/)에서 확인하십시오.
...
1. 모든 수강생은 해당 장을 미리 읽고, 수업 전까지 eTL 게시판에 토론 질문을 하나 이상 올립니다.
2. 토론 질문은 단순 감상이나 용어 확인에 그치지 않고, 본문 대목의 주장·전제·추론·사례·반론 가능성 중 하나를 겨냥해야 합니다.
3. 발제자는 필독 범위를 정리하고 핵심 개념 및 토론 질문을 작성하여 eTL에 업로드합니다.
4. 다른 수강생들은 예습하며 주요 문장에 밑줄, 질문 메모를 준비합니다.

#### 수업 중

1. 발제자가 요약 내용을 발표하며 중요한 개념과 문장을 함께 읽습니다.
2. 논쟁적인 구절은 교수자 또는 다른 학생들이 제안하여 함께 읽고 해석합니다.
3. 발제자는 챕터의 핵심 논증을 설명하고 토론 질문을 제안하여 수강생 전원이 함께 토론합니다.
...
- Hart는 법을 ‘내부 관점’에서 이해해야 한다고 했다. 나는 법을 내면화하고 있는가, 단지 외면적으로 복종하는가?
...
1. 모든 수강생은 필독 범위를 읽고 eTL 게시판에 토론 질문을 하나 이상 업로드  
2. 발제자는 필독 범위 요약, 핵심 개념, 토론 질문 작성(eTL 업로드)  
3. 수강생은 밑줄 및 질문 준비
