...
* **법의 구조**(rule structure), **공무담당자의 역할**, **내부 관점(internal point of view)**과 같은 개념들을 **실제 사회생활 속의 관찰된 현상**으로 분석
...
하트의 descriptive sociology는 특히 다음 개념들에 대한 기술을 포함합니다:

| 개념                                | 설명                                                                 |
| --------------------------------- | ------------------------------------------------------------------ |
| **규칙(rule)**                      | 단순한 반복행위가 아닌, 그에 대한 사회적 수용과 규범적 기대가 있는 행위 패턴                       |
| **내부 관점(internal point of view)** | 사람들이 규칙을 단순히 '따르는 것'이 아니라, **그 규칙을 행위와 비판의 기준으로 수용하는 태도**             |
| **공무담당자(official)**              | 단순히 권위자가 아니라, **규칙을 공무담당 방식으로 해석하고 적용하는 역할을 맡은 자**                 |
| **규칙의 이중 구조(two types of rule)**  | 일차 규칙(primary rules: 책무를 부과), 이차 규칙(secondary rules: 규칙을 식별·변경·적용) |
...
* 드워킨은 하트의 "기술적 사회학"이 **법의 규범적 본질**을 설명하는 데 실패한다고 주장
  ...
  > 법은 단지 사람들이 받아들이는 관행이나 내부 관점의 태도 이상의 것.
  > 오히려 **원칙(principles)**에 의해 구조화된 해석적 실천이어야 한다고 봄

### (3) **브라이언 라이터(Brian Leiter)와 현대적 재해석**

* 레이터는 하트의 descriptive sociology를 **자연화된 법리학(naturalized jurisprudence)**의 일환으로 재해석
...
| 항목     | 설명                                        |
| ------ | ----------------------------------------- |
| 목적     | 법의 개념과 구조를 **사회적 현실에 기반하여 기술**하고 설명       |
| 방법     | 개념 분석 + 사회적 맥락에서의 규칙 사용의 관찰               |
| 주요 개념  | 규칙, 내부 관점, 규칙의 이중구조, 공무담당자의 역할 등             |
