...
\textbf{Austin, The Province}   & \textit{\small Austin, The Province of Jurisprudence Determined} (ed. Hart, London, 1954) \\
\textbf{Austin, The Lectures}   & \textit{\small Austin, Lectures on the Philosophy of Positive Law} \\
\textbf{Kelsen, General Theory} & \textit{\small Kelsen, General Theory of Law and State} \\
\textbf{BYBIL}                  & \textit{\small British Year Book of International Law} \\
\textbf{HLR}                    & \textit{\small Harvard Law Review} \\
\textbf{LQR}                    & \textit{\small Law Quarterly Review} \\
\textbf{MLR}                    & \textit{\small Modern Law Review} \\
\textbf{PAS}                    & \textit{\small Proceedings of the Aristotelian Society} \\
\end{tabular}

\subsection{CHAPTER I NOTES}\label{chapter-i-notes}

\small \emph{Pages} 1--2. Each of the quotations on these pages from Llewellyn,
