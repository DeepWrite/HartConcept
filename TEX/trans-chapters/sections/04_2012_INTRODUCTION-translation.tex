...
토마스 아퀴나스는 법이 \emphksans{총체적} 목적(\emph{overall} purpose)을
...
결국, 정의\emphksans{의 형식}(\emph{the form of} justice)을 가진 모든 것이
반드시 정의의 \emphksans{한} 형식(\emph{a} form of justice)인 것은 아니다.
...
도덕에 따라 법을 \emphksans{창출하라}(\emph{make} law)는 지시를 내리는 것일
...
체계(system)가 아니라 규칙들의 \emphksans{집합}(\emph{set} of rules)으로
